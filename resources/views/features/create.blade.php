<x-project-features-layout :project="$project" :features="$allProjectFeatures" :active-feature-id="null">
    <x-slot name="header">
    ...
    <x-slot name="sidebar">
        <x-project-features-nav
            ...
            :active-feature-id="null"
        />
    </x-slot>


    {{-- ALL THE EXISTING CONTENT OF YOUR create.blade.php GOES HERE --}}
