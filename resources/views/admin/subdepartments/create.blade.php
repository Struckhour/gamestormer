        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-4">New Subdepartment Details</h3>
                    ...
                    <form method="POST" action="{{ route('admin.subdepartments.store') }}">
                        @csrf
